package com.chuangdun.flutter.plugin.trtc.widget;
...
import com.chuangdun.flutter.plugin.trtc.R;
...
public class TRTCMoreDialog extends Dialog implements View.OnClickListener {
  ...
  private void initView() {
    ...
    mRbLocalVideoMirrorAuto
        .setChecked(mLocalVideoViewMirror == TRTCCloudDef.TRTC_VIDEO_MIRROR_TYPE_AUTO);
    mRbLocalVideoMirrorDisable
        .setChecked(mLocalVideoViewMirror == TRTCCloudDef.TRTC_VIDEO_MIRROR_TYPE_DISABLE);
  ...
  private void loadLocalCache(Context context) {
    try {
      ...
      mAudioVolumeEvaluation = shareInfo
          .getBoolean(KEY_AUDIO_VOLUME_EVALUATION, mAudioVolumeEvaluation);
  ...
  public boolean isCameraFrontSync(Context context) {
    SharedPreferences shareInfo = context.getSharedPreferences(KEY_MORE_SETTING_DATA, 0);
    return shareInfo.getBoolean(KEY_CAMERA_FRONT, mCameraFront);
  }

  public void updateCameraFront(Context context, boolean cameraFront) {
    SharedPreferences shareInfo = context.getSharedPreferences(KEY_MORE_SETTING_DATA, 0);
    SharedPreferences.Editor editor = shareInfo.edit();
    editor.putBoolean(KEY_CAMERA_FRONT, cameraFront);
    editor.commit();
  }
